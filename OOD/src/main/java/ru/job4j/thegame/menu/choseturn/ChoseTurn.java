 ...
 * @since 23.10.19
 */
public class ChoseTurn implements IMenu {
    ...
    private void addMenuItems() {
        this.menuItems.put("1", new MyTurn());
        this.menuItems.put("2", new ComputerTurn());
        this.menuActions.put("1", new MyTurn());
        this.menuActions.put("2", new ComputerTurn());
    }
    ...
    public void showMenu() {
        addMenuItems();
        System.out.println("Please select whom start first.");
